        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 12) {
                ...
                if FeatureFlags.isAnalyzeEnabled {
                    toolButton(.analyze, icon: "doc.text.magnifyingglass", title: "\u9898\u76ee\u5206\u6790", subtitle: "\u6df1\u5ea6\u89e3\u6790\u9898\u5e72")
                }

                if FeatureFlags.isImageUploadEnabled {
                    toolButton(.upload, icon: "camera.fill", title: "\u62cd\u7167\u5206\u6790", subtitle: "\u4e0a\u4f20\u9898\u76ee\u56fe\u7247")
                }

                if FeatureFlags.isGradeEnabled {
                    toolButton(.grade, icon: "checkmark.circle.fill", title: "\u4f5c\u4e1a\u6279\u6539", subtitle: "\u667a\u80fd\u8bc4\u5206\u53cd\u9988")
                }

                if FeatureFlags.isWrongQuestionsEnabled {
                    toolButton(.wrongQuestions, icon: "xmark.circle.fill", title: "\u9519\u9898\u590d\u4e60", subtitle: "SM-2 \u95f4\u9694\u590d\u4e60")
                }

                if FeatureFlags.isStatsEnabled {
                    toolButton(.stats, icon: "chart.bar.fill", title: "\u5b66\u4e60\u7edf\u8ba1", subtitle: "\u6570\u636e\u603b\u89c8\u5206\u6790")
                }

                toolButton(.realExam, icon: "book.pages.fill", title: "\u771f\u9898\u6f14\u7ec3", subtitle: "\u8fd1\u5341\u5e74\u771f\u9898\u5e93")
            }
        }
    }

    private func toolButton(_ item: SidebarItem, icon: String, title: String, subtitle: String) -> some View {
        Button { onToolSelected(item) } label: {
            ToolCard(icon: icon, title: title, subtitle: subtitle)
        }
        .buttonStyle(.plain)
    }
}
