...
// ai
export { AIGateway, structuredCall, embedTexts, retrieveReferences, runOCR, recordApiUsage, queryUserUsage, runEval, evalCase, computeDimensions, allSamples, gradeMathSamples, gradeEssaySamples, geometrySamples, scoreGeometry, geometryOverallScore, geometryCasePassed, GEOMETRY_DIMENSIONS, GEOMETRY_CASE_PASS_THRESHOLD, chartSamples, scoreChart, chartOverallScore, chartCasePassed, CHART_DIMENSIONS, CHART_CASE_PASS_THRESHOLD, evalExpr, composePrompt, composeMessages, getLearnerContext, buildLearnerModel, sm2Update, sm2Defaults, DEFAULT_LEARNER_MODEL, getPersona, personaSystemPrompt, normalizeSubject, getTaskInstruction, schemaToFormatInstruction, GEOMETRY_SYSTEM_PROMPT, GEOMETRY_BLOCK_INSTRUCTION, buildGeometryUserPrompt, CHART_SYSTEM_PROMPT, buildChartUserPrompt, TASK_ROUTING, TASK_SCHEMA, AIStructuredError, formatZodError, tryParseJson, registerProvider, pick, listProviders, getProvider, runChatAgent, loadMemory, appendTurn, upsertFact, composeMemoryBlock, summarizeConversation, shouldSummarize, composeSummaryBlock, splitWindow, RAW_WINDOW, SUMMARY_TRIGGER, loadUserFacts, composeUserFactsBlock, upsertUserFact, forgetUserFact, MAX_USER_FACTS, storeUserMemory, retrieveUserMemory, embedUserMemory, composeEpisodicBlock } from './ai';
export type { TaskName, Capability, ChatMessage, ChatRequest, TokenUsage, AIProvider, RAGReference, RetrieveOptions, ComposeOptions, LearnerModel, LearnerPace, LearnerPreferences, LearningEvent, KnowledgeMasteryEntry, SM2State, EvalCase, EvalResult, EvalReport, EvalDimension, GeometryEvalCase, GeometryDimension, ChartEvalCase, ChartDimension, AnalyzeOutput, ChatOutput, PlanOutput, ChatAgentOutput, ChatAction, ChatAgentResult, MemoryContext, AgentMemory, TurnInput, EpisodicMemory, MemoryFact, UpsertFactResult, StoredFact, StoreUserMemoryInput, UserMemorySource, Block, GeometryAST, GeometryOutput, GeometryElement, ChartBlock, ChartOutput } from './ai';
